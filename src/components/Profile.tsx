...
const Profile = () => {
  return (
    <div>
    <div className="flex flex-col h-screen sm:flex-row sm:justify-between items-center sm:items-start lg:space-x-20 pt-8 sm:pt-12 pb-10 px-4 sm:px-8 lg:px-14 max-w-5xl mx-auto">
      ...
      <div className="flex flex-col items-center sm:items-start text-center sm:text-left">
        <div className="pt-4 sm:pt-0 space-y-3 sm:space-y-2">
          ...
          <p className="font-mono text-slate-300 text-xl sm:text-2xl max-w-md">
            i'm a full-stack devloper who loves building cool products.
          </p>
        </div>
