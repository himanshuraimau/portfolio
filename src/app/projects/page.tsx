...
export const deepCSProjects = [
  ...
  },
  {
    ...
    githubUrl: "https://github.com/himanshuraimau/applied-os/tree/main/MultiThreadedProxyServerClient",
    type: "github",
  },
  {
    id: 7,
  ...
  },
  {
    ...
    description: "This project sets up a reverse proxy using Node.js, Express, and Docker.",
  ...
  },
  {
    ...
    description: "A Go application that serves as a fully functional RSS aggregator.",
    technologies: ["Go", "PostgreSQL", "REST API"],
    githubUrl: "https://github.com/himanshuraimau/backend_projects/tree/main/rssaggregator",
    type: "github",
  },
  {
    id: 11,
    title: "YouTube-like Backend Service",
    description: "This project is a backend service designed to support a YouTube-like application.",
  ...
  },
  {
    ...
    description: "This project establishes a connection to a proxy server, sends a request, and forwards data through the proxy.",
    technologies: ["C", "Networking"],
    githubUrl: "https://github.com/himanshuraimau/c-projects/tree/main/toralize",
    type: "github",
  },
];
                ...
                <div className="p-4 flex flex-col flex-grow">
                  <div className="flex-grow">
                    ...
                    <div className="flex flex-wrap gap-1 mb-3">
                      {project.technologies.map((tech) => (
                        <span key={tech} className="px-2 py-1 bg-muted text-muted-foreground rounded-full text-xs">
                          {tech}
                        </span>
                      ))}
                    </div>
