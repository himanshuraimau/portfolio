...
![image.png](/public/proxy/doc.webp)
...
{% if site.theme == "dark" %}
![System Design](/public/proxy/system-dark.png)
{% else %}
![System Design](/public/proxy/system-light.png)
{% endif %}
...
![Reverse Proxy Setup](/public/proxy/logs.png)
